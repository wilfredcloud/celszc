    ...
    <div className=" my-20 py-20 bg-slate-200">
      <div className="container mx-auto px-4 ">
        ...
        <div className=" text-center max-w-3xl mx-auto">
          ...
          <h3 className=" italic text-lg my-4 font-semibold   text-amber-500">
            Congratulations!
          </h3>

          <p className=" italic text-lg  ">
            You are now a child of God. To receive more information on how you
            will grow as a Christain <br />
